    ...
    <v-app>
        <div class="app-container">
            <div class="app-bar">
                ...
                <v-menu class="select_view" close-on-click transition="slide-y-transition">
                    <template v-slot:activator="{ on, attrs }">
                        <v-btn v-bind="attrs" v-on="on" class="ml-5">Views</v-btn>
                    </template>
                    <v-list>
                        <v-list-item
                            v-for="view in viewsMapping"
                            :key="view.view"
                ...
                <multiselect
                    class="select_classifiers"
                    placeholder="Excluded classifiers"
                    v-model="value_classifier"
                    :options="classifiers"
                    multiple
                ></multiselect>
                ...
                <v-btn class="ml-16" v-on:click="btnClick('Git Repo')">Git Repo</v-btn>
                <v-menu class="select_help" close-on-click transition="slide-y-transition">
                    <template v-slot:activator="{ on, attrs }">
                        <v-btn v-bind="attrs" v-on="on" class="ml-5">Help</v-btn>
                    </template>
                    <v-list>
                        <v-list-item
                            v-for="button in helpButtons"
                            :key="button.name"
            ...
            <div class="main">
                ...
                <RigidTileHome />
                <v-snackbar v-model="snackbar" style="text-align: center;" :timeout="0">
                    <span>SET UNION MODE</span>
                </v-snackbar>
            </div>
        </div>
    </v-app>
